...
1. Clone the Repository:
   git clone https://github.com/your-username/meeting-iq.git
   cd meeting-iq

2. Install Dependencies:
   Ensure you have Python 3.9+ installed, then run:
   pip install streamlit pandas langchain-chroma langchain-community langchain-core langchain-groq groq python-dotenv pypdf python-docx
...
3. Configure Environment Variables:
   ...
   Note on Email Notifications: GMAIL_PASS must be a Gmail App Password, not your standard login password. You can generate this under your Google Account Security settings if 2-Factor Authentication is active.

4. Run the Application:
   streamlit run app.py

The application will automatically initialize the local databases and launch in your default web browser at http://localhost:8501.

---

## 📊 Database Schema Breakdowns

MeetingIQ stores analytics across 7 interconnected tables within SQLite:
* meetings: Core tracking ledger for uploaded assets.
* projects: Ongoing corporate initiatives, descriptions, and statuses.
* action_items: Tasks, owners, priority flags, and deadlines.
* escalations: High-priority operational bottlenecks with resolution tracking.
* risks: Risk registry documenting cross-team dependencies and downstream impacts.
* decisions: Central log capturing explicit choices, rationales, and owners.
* stakeholders: Rolodex compiling team participation frequency across events.

---

## 🔒 Security & Data Privacy

* Local Storage: Transcripts, embeddings, vector indices, and relational data are stored completely locally on your machine via SQLite and ChromaDB.
* API Security: Data payloads sent to Groq are strictly bound to processing workflows governed by your private API keys.
